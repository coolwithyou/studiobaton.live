...
/**
 * PATCH /api/admin/standup/task/[taskId]
 * 할 일 수정 (완료 체크, 내용 수정)
 */
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    logError("PATCH /api/admin/standup/task/[taskId]", error);
...
/**
 * DELETE /api/admin/standup/task/[taskId]
 * 할 일 삭제
 */
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    logError("DELETE /api/admin/standup/task/[taskId]", error);
    const normalizedError = normalizeError(error);
