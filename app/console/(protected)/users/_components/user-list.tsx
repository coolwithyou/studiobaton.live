...
export function UserList({ users, onUserChange, showPendingActions }: UserListProps) {
  ...
  const handleApprove = async (id: string) => {
    setLoadingId(id);
    try {
      const response = await fetch(`/api/console/users/${id}/approve`, {
        method: "POST",
      });
  ...
  const handleReject = async (id: string) => {
    setLoadingId(id);
    try {
      const response = await fetch(`/api/console/users/${id}/reject`, {
        method: "POST",
      });
  ...
  const handleDelete = async (id: string) => {
    setLoadingId(id);
    try {
      const response = await fetch(`/api/console/users/${id}`, {
        method: "DELETE",
      });
